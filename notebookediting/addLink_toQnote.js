...
document.getElementById("printing_button").addEventListener("click", () => {
    var printContents = Array.from(document.querySelectorAll('.pagebook')).map(function(el) {
    ...
    // Create separate containers for each pagebook
    printContents.forEach(function(el, index) {
    ...
    // Remove page-break-after from the last container
